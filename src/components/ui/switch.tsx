...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:[transform:translateX(1.25rem)] data-[state=unchecked]:[transform:translateX(0)] rtl:data-[state=checked]:[transform:translateX(-1.25rem)]"
      )}
    />
  </SwitchPrimitives.Root>
));
