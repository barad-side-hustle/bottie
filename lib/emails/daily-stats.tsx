          ...
          <Container className="border border-solid border-border rounded-xl shadow-sm my-[40px] mx-auto p-[32px] max-w-[600px] bg-card">
            ...
            <Section className="my-6">
              ...
              {newUsers.length === 0 ? (
                ...
                <div className="bg-surface border border-solid border-border rounded-xl p-4">
                  {newUsers.map((u, i) => (
              ...
              <>
                ...
                <Section className="my-6">
                  ...
                  <div className="bg-surface border border-solid border-border rounded-xl p-4">
                    ...
                    <Hr className="border-border mx-0 w-full my-2" />
            ...
            <Section className="mt-6">
              <Text className="text-subtle text-xs text-center m-0">Bottie.ai Daily Stats</Text>
            </Section>
          </Container>
        </Body>
      </Tailwind>
